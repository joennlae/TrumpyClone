var aboutLayer = cc.Layer.extend({
    ...
    init: function(){
        ...
        this.messageLabel = new cc.LabelTTF(text, "res/Quicksand-Light.ttf",this.winsize.height/50, cc.size(this.winsize.width-40,this.winsize.height-40-this.winsize.height / 20) ,cc.TEXT_ALIGNMENT_CENTER,cc.VERTICAL_TEXT_ALIGNMENT_TOP);
