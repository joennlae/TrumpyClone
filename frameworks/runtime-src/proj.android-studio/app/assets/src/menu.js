var menuLayer = cc.Layer.extend({
    ...
    init:function(){
		...
		this.startLabel = new cc.LabelTTF("Play", "res/res/Quicksand-Light", this.winsize.height/4);
		...
		this.startLabelP = new cc.LabelTTF("Play", "res/Quicksand-Light", this.winsize.height/4);
        ...
        this.betaLabel = new cc.LabelTTF("Beta", "res/Quicksand-Light", this.winsize.height/10);
        this.betaLabel.setColor(cc.color(0,0,0));//black color
        //this.startLabel.setPosition(cc.p(this.winsize.width/2, this.winsize.height/2));
        
        this.betaLabelP = new cc.LabelTTF("Beta", "res/Quicksand-Light", this.winsize.height/10);
        this.betaLabelP.setColor(cc.color(0,0,150));//blue color
        //this.startLabelP.setPosition(cc.p(this.winsize.width/2, this.winsize.height/2));
		
        this.settingsLabel = new cc.LabelTTF("Settings", "res/Quicksand-Light", this.winsize.height/10);
        this.settingsLabel.setColor(cc.color(0,0,0));//black color
        //this.startLabel.setPosition(cc.p(this.winsize.width/2, this.winsize.height/2));
        
        this.settingsLabelP = new cc.LabelTTF("Settings", "res/Quicksand-Light", this.winsize.height/10);
        this.settingsLabelP.setColor(cc.color(0,0,150));//blue color
        //this.startLabelP.setPosition(cc.p(this.winsize.width/2, this.winsize.height/2));
        
        this.messageLabel = new cc.LabelTTF(startUpMessages[Math.floor(Math.random()*(startUpMessages.length))], "res/Quicksand-Light", this.winsize.height/12);
